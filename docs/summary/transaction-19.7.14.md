...
> **参考资料:** 
>
> [深入分析事务的隔离级别](https://www.hollischuang.com/archives/943)「Hollis」, 这篇文章中不止解释了事务的隔离级别, 其中还包含了事务相关的其他内容, 比如: [数据库事务](https://www.hollischuang.com/archives/898), [数据库的读现象浅析](https://www.hollischuang.com/archives/900), [数据库的锁机制](https://www.hollischuang.com/archives/909)
>
> [数据库事务隔离级别和锁实现机制](https://comedsh.iteye.com/blog/698733)「伤神」
>
> [事务相关的内容](http://www.hollischuang.com/archives/tag/事务)「Hollis」Hollis大神还很贴心的将他写的事务相关的文章进行了整理
>
> [Spring事务传播行为](https://www.byteslounge.com/tutorials/spring-transaction-propagation-tutorial)
